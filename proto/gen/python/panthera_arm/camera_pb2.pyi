...
class CameraStatus(_message.Message):
    __slots__ = ("enabled", "available", "streaming", "model", "serial", "firmware", "usb_type", "sdk_version", "error", "last_frame_age_ms", "actual_fps", "profiles")
...
class CameraFrame(_message.Message):
    __slots__ = ("stream", "pixel_format", "sequence", "captured_at_ns", "device_timestamp_ms", "width", "height", "stride", "depth_scale", "data")
    STREAM_FIELD_NUMBER: _ClassVar[int]
    PIXEL_FORMAT_FIELD_NUMBER: _ClassVar[int]
    ...
    depth_scale: float
    data: bytes
    def __init__(self, stream: _Optional[_Union[CameraStreamType, str]] = ..., pixel_format: _Optional[_Union[CameraPixelFormat, str]] = ..., sequence: _Optional[int] = ..., captured_at_ns: _Optional[int] = ..., device_timestamp_ms: _Optional[float] = ..., width: _Optional[int] = ..., height: _Optional[int] = ..., stride: _Optional[int] = ..., depth_scale: _Optional[float] = ..., data: _Optional[bytes] = ...) -> None: ...
