...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="Panthera-WAM RealSense D405 采集服务")
    parser.add_argument(
        "--mode",
        choices=("auto", "sim"),
    ...
    parser.add_argument("--check", action="store_true", help="用仿真相机执行 gRPC 自检后退出")
    return parser
